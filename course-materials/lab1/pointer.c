...
int withinSameBlock(int * ptr1, int * ptr2) {
  // TODO
  int mask = 64;
  int addr_ptr1 = (char *)ptr1 - (char *)0;
  int addr_ptr2 = (char *)ptr2 - (char *)0;
  int ret = !((addr_ptr1 >> 6) ^ (addr_ptr2 >> 6));
  return ret;
}
...
int withinArray(int * intArray, int size, int * ptr) {
  // TODO
  int ptr_diff = ptr - intArray;
  int msb_ptr_diff = (ptr_diff >> 31) & 1;
  int size_diff = size - ptr_diff - 1;
  int msb_size_diff = (size_diff >> 31) & 1;
  return (!msb_ptr_diff) & (!msb_size_diff);
}
/*
